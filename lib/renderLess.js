			...
			parser.parse( dataString, function ( error, cssTree ) {
				...
				fs.writeFile( options.outputDir + options.outputfile, cssString, 'utf8', function (err) {
					...
					minifier({
						...
						js : {
							inputs: [
								__dirname + "/../content/scripts/plugins/jquery.noty.packaged.min.js",
								__dirname + "/../content/scripts/plugins/jquery.validate.min.js",
								__dirname + "/../content/scripts/plugins/bootstrap.min.js",
								__dirname + "/../content/scripts/plugins/dust-core.min.js",
								__dirname + "/../content/scripts/plugins/swipe.js",
								__dirname + "/../content/scripts/il.library.js",
								__dirname + "/../content/scripts/_layout.js",
								__dirname + "/../content/scripts/contact.js",
								__dirname + "/../content/views/project.js"
							],
